<?php
echo $this->Html->script('c/orders/edit', array('inline' => false));
?>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="orders form">
                        ...
                        echo $this->Html->link('取消', array('controller' => 'accounts', 'action' => 'view', $this->request->data['Order']['account_id']), array('class' => 'btn btn-default'));
                        echo $this->Form->end();
                        ?>
                    </div>
                </div>
