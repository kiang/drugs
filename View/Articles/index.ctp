        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="<?php echo $article['Article']['id']; ?>-content">
                ...
                if (!empty($article['Article']['url'])) {
                    ...
                    echo '</p>';
                    echo '<p class="text-ellipsis"><span class="fui-info-circle text-muted"></span>&nbsp;' . $this->Html->link($article['Article']['url'], $article['Article']['url'], array('target' => '_blank', 'class' => 'article-link', 'escape' => false));
                    echo '</p>';
                }
                ?>
            </div><!-- /.tab-pane -->
